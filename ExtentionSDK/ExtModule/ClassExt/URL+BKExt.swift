...
extension URL {
    ...
    func bk_getExtendedAttribute(forName name: String) throws -> Data {
    ...
    func bk_setExtendedAttribute(data: Data, forName name: String) throws {
    ...
    func bk_removeExtendedAttribute(forName name: String) throws {
        try withUnsafeFileSystemRepresentation { fileSystemPath in
    ...
    func bk_listExtendedAttributes() throws -> [String] {
