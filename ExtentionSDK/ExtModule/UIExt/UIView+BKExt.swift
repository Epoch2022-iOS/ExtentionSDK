...
extension UIView {
    ...
    func bk_addSelectedButton(font: UIFont = .systemFont(ofSize: 15),
                              ...
                              selectTitleColor: UIColor = .white) -> UIButton {
        let btn = UIButton()
        btn.titleLabel?.font = font
        btn.setTitle(title, for: .normal)
    ...
    func bk_addSelectedGradientButton(font: UIFont = .systemFont(ofSize: 15),
                                      ...
                                      selectTitle: String,
                                      titleColor: UIColor = .lightWhiteDark27,
                                      selectTitleColor: UIColor = .white,
                                      gradientType: UIImage.GradientType = .leftToRight,
                                      gradientSize: CGSize,
                                      colors: [UIColor],
...
extension UIView {
    ...
    /// 添加Label
    func bk_addPaddingLabel(text: String? = nil,
                            font: UIFont = .systemFont(ofSize: 15),
                            bgColor: UIColor = .lightWhiteDark27,
                            textColor: UIColor = .white,
                            align: NSTextAlignment = .left) -> BKPaddingLabel {
        
        let label = BKPaddingLabel()
        label.backgroundColor = bgColor
        label.textColor = textColor
        label.text = text
        label.numberOfLines = 0
...
extension UIView {
    ...
    func bk_addMask(alpha: CGFloat = 0.5) {
        let _view = UIView()
        _view.backgroundColor = UIColor.white.withAlphaComponent(alpha)
...
class BKCornersShadowView: UIControl {
    ...
    private func initViews() {
        ...
        layer.bk_shadowColor(.white, with: self)
...
extension UIView {
    ...
    */
    ...
    public func bk_addShadowStyleWith(cornerRadius: CGFloat?,
        ...
        switch style {
        case .deep:
            self.bk_addStyleWith(cornerRadius: cornerRadius, corners: corners, shadowRadius: 3, shadowOffset: CGSize(width: 1, height: 2), shadowOpacity: 0.5, shadowColor: .white)
        case .shallow:
            self.bk_addStyleWith(cornerRadius: cornerRadius, corners: corners, shadowRadius: 5, shadowOffset: CGSize(width: 0, height: 2), shadowOpacity: 0.5, shadowColor: .white.withAlphaComponent(0.3))
        default:
    ...
    /// - Parameters:
    ///   - img: 背景图片
    func bk_addBlurBackground(img: UIImage?, style: UIBlurEffect.Style) {
